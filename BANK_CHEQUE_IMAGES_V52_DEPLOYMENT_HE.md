...
במסד נשמרים רק מפתחות SHA-256 קטנים בתוך פרטי השיק; קובץ התמונה נשמר ב-Storage ונמחק לאחר 183 יום (כחצי שנה).
...
6. אין לצפות לכשישה חודשי תמונות מיד ביום הראשון: הסנכרון הרגיל מביא כ-30 יום. עם הזמן נשמר חלון מתגלגל של 183 יום.
7. לאחר שעוברים 183 יום, סנכרון בנק מאוחר יותר מוחק את קובץ התמונה דרך Storage API. תנועת הבנק ופרטי השיק עצמם נשארים בארכיון.
