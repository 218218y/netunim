...
המסלול הזה **עדיין אינו מפעיל V2 להתקנה חדשה או ל־owner מקומי בייצור**: אין עדיין marker עמיד ל־local engine, ואין startup שמבצע migration ו־parity לפני סימונו. כמו כן, local→account עדיין אינו משתמש ב־bootstrap ישיר מתוך שני ה־journals המקומיים, ומעבר account A→B טרם חובר ל־detached recovery בייצור. לכן אין להסיר עדיין V1 או להכריז על zero-V1 לכל המצבים. ה־cutover של חשבון קיים הוא מסלול נפרד, ולפני cleanup יש לאמת אותו בשני המחשבים בפועל.
