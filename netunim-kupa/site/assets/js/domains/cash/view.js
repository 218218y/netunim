...
function renderCash(){
  ...
  const rightsKpi=`<div class="rights-kpi-wrap">${kpi('יתרת מעשר',rightsBalance(),'#eef1f8','#7f86a6','מחושב מכל תנועות הזכות')}<div class="rights-calculated-date"><span>חושב לאחרונה בתאריך</span>${dateEditorMarkup('',model.state.rightsLastCalculatedDate||'',{label:'תאריך חישוב אחרון של יתרת המעשר',change:'set-rights-last-calculated-date',compact:true})}</div></div>`;
