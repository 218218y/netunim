...
import {checkBankReviewMarkup,checkBankStatusMarkup} from '../../shared/check-bank-review.js';
...
return { badgeStatus, dueBadge, checkFocusMatch, clearCheckFocus, visibleChecks, visibleChecksTotal, renderChecks, renderChecksSearch, renderCheckGroups, checkRow, checkForecastMarkup };
}
