...
async function refreshOrdersFinanceSummary({force=false,renderIfChanged=true}={}){
  ...
  session.ordersFinanceReadPromise=(async()=>{
    ...
    if(changed)touchOrdersFinanceRevision();
