...
function renderDashboard(){
  ...
  <div class="net-summary dashboard-net-summary"><div class="net-mini"><span>עו״ש עסקי מעודכן</span><b>${formatNullableMoney(long.bank)}</b></div><div class="net-mini"><span>כל האשראי העסקי שנותר${partial?' · חלקי':''}</span><b>− ${money(long.credit)}</b>${partial?`<small>סכום ₪ ידוע בלבד${partialFacts.length?` · ${esc(partialFacts.join(' · '))}`:''}</small>`:''}</div><div class="net-mini"><span>הוצאות עסקיות חודש אחד</span><b>− ${money(long.expenses)}</b><small>${monthLabel(long.targetMonth)}</small></div><div class="net-mini"><span>סה״כ קופה</span><b>+ ${money(long.kupa)}</b><small>מזומן + צקים שטרם הופקדו</small></div><div class="net-mini"><span>חוב לקוחות פתוח</span><b>${long.customerOpen===null?'—':`+ ${money(long.customerOpen)}`}</b></div><div class="net-mini"><span>נטו ספקים</span><b>${long.supplierNet===null?'—':money(long.supplierNet)}</b></div><div class="net-total"><span>מאזן כולל נטו${partial?' · חלקי':''}</span><b>${formatNullableMoney(long.net)}</b><small>עו״ש עסקי − כל האשראים העסקיים העתידיים − חודש הוצאות עסקיות + קופה + חוב לקוחות פתוח + נטו ספקים${partial?' · מבוסס על סכומי ₪ הידועים כרגע':''}</small></div></div>
