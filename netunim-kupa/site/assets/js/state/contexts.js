...
return {
  model:{
    state:{version:4,businessName:'ניהול קופה',checks:[],credits:[],creditSync:{version:3,mode:'synced',syncedAt:null,profiles:[],errors:[],cardMappings:{}},cash:[],rights:[],expenses:[],cards:[],bank:{currentBalance:null,updatedAt:null,asOfDate:null,adjustments:[],homeFeed:null}},
