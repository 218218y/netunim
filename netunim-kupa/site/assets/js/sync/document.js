...
async function reconcileCloudPending(remoteRow=null){
  ...
  try{
    ...
    replaceVisibleState(applyKupaCoreState(pending.snapshot,model.state.checks));persistImmediateBrowserSnapshot(model.state,pending.baseRevision||session.dbRevision);
