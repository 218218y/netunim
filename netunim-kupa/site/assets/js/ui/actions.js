...
return {
  ...
  'set-credit-card-sort-order':(element,event)=>{setCreditCardMapping(element.dataset.changeArg0,element.dataset.changeArg1,'sortOrder',element.value)},
