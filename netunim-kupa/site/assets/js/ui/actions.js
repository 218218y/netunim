...
return {
  ...
  'credit-detail-upcoming':(element,event)=>{ui.creditDetailMode='upcoming';ui.creditDetailFocus=null;renderCredit()},
  'credit-detail-month':(element,event)=>{ui.creditDetailMode='month';ui.creditDetailFocus={monthKey:element.dataset.clickArg0||'',cardKey:''};renderCredit()},
  'credit-detail-focus':(element,event)=>{ui.creditDetailMode='month';ui.creditDetailFocus={monthKey:element.dataset.clickArg0||'',cardKey:element.dataset.clickArg1||''};renderCredit();requestAnimationFrame(()=>document.getElementById('credit-active-transactions')?.scrollIntoView({behavior:'smooth',block:'start'}))},
