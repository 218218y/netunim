...
return {
  ...
  'refresh-credit-sync':(element,event)=>{event?.preventDefault();event?.stopPropagation();refreshCreditSync({interactive:false,auto:false,syncMode:'daily'})},
  'refresh-credit-sync-full':(element,event)=>{event?.preventDefault();event?.stopPropagation();refreshCreditSync({interactive:false,auto:false,syncMode:'full'})},
