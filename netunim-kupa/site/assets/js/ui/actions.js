...
return {
  ...
  'check-account':(element,event)=>{ui.checkBankHistoryPage=0;ui.checkAccount=element.dataset.clickArg0==='ביתי'?'ביתי':'עסקי';ui.checkFocus='all';ui.bulkSelected.clear();renderChecks()},
  ...
  'credit-detail-upcoming':(element,event)=>{ui.creditDetailMode='upcoming';ui.creditDetailChargeDay='all';ui.creditDetailFocus=null;renderCredit()},
  'credit-detail-upcoming-day':(element,event)=>{const day=element.dataset.clickArg0==='10'?'10':'15',active=ui.creditDetailMode==='upcoming'&&ui.creditDetailChargeDay===day;ui.creditDetailMode='upcoming';ui.creditDetailChargeDay=active?'all':day;ui.creditDetailFocus=null;renderCredit()},
  'credit-detail-month':(element,event)=>{ui.creditDetailMode='month';ui.creditDetailChargeDay='all';ui.creditDetailFocus={monthKey:element.dataset.clickArg0||'',cardKey:''};renderCredit()},
  'credit-detail-month-day':(element,event)=>{const monthKey=element.dataset.clickArg0||'',day=element.dataset.clickArg1==='10'?'10':'15',active=ui.creditDetailMode==='month'&&ui.creditDetailFocus?.monthKey===monthKey&&ui.creditDetailChargeDay===day;ui.creditDetailMode='month';ui.creditDetailChargeDay=active?'all':day;ui.creditDetailFocus={monthKey,cardKey:''};renderCredit()},
  ...
  'clear-credit-detail-focus':(element,event)=>{ui.creditDetailMode='month';ui.creditDetailFocus={monthKey:element.dataset.clickArg0||ui.creditDetailFocus?.monthKey||'',cardKey:''};renderCredit()},
