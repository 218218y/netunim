...
return {
  ...
  'refresh-bank-from-hapoalim':(element,event)=>{refreshBankBalance({interactive:false,auto:false})},
  'open-bank-auth':(element,event)=>{refreshBankBalance({interactive:true,auto:false})},
