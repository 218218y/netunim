...
export function createUiNavigation({ui, renderDashboard, renderChecks, renderCredit, renderCash, renderBank, renderSettings}){
...
function render(){if(ui.currentPage==='dashboard')renderDashboard();if(ui.currentPage==='checks')renderChecks();if(ui.currentPage==='credit')renderCredit();if(ui.currentPage==='cash')renderCash();if(ui.currentPage==='bank')renderBank();if(ui.currentPage==='expenses')renderBank();if(ui.currentPage==='settings')renderSettings()}
