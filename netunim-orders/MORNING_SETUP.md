...
בטופס תקבול מוצגים רק השדות הרלוונטיים לאמצעי התשלום: מזומן — תאריך וסכום; העברה בנקאית — אסמכתא, בנק, סניף וחשבון; צ׳ק — בנק, סניף, חשבון ומספר צ׳ק; כרטיס אשראי — סוג כרטיס וארבע ספרות אחרונות. רשימת הבנקים המקומית מבוססת על קודי הזיהוי של בנק ישראל, אך שדה הבנק נשאר גם שדה טקסט כדי לא לחסום ערך ידני.
