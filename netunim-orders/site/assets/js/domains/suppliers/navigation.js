...
function switchSupplier(id){if(!id||id===supplierUi.currentSupplierId)return;supplierUi.supplierMoveTargetId=null;supplierUi.supplierBulkSelected.clear();supplierUi.currentSupplierId=id;ui.currentView='supplier';supplierUi.supplierYearView='current';supplierUi.searchText='';render({supplierScrollMode:'end'})}
