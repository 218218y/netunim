...
const uiActions=createUiActions({
  ...
  supplierMenu:domainsSuppliersNavigation,
  ...
  setCustomerTab:(...args)=>domainsCustomers.setCustomerTab(...args),
  toggleCustomerBulkMode:(...args)=>domainsCustomers.toggleCustomerBulkMode(...args),
  toggleCustomerBulkRow:(...args)=>domainsCustomers.toggleCustomerBulkRow(...args),
  toggleCustomerBulkVisible:(...args)=>domainsCustomers.toggleCustomerBulkVisible(...args),
  deleteSelectedCustomerRows:(...args)=>domainsCustomers.deleteSelectedCustomerRows(...args),
  renderCustomers:(...args)=>domainsCustomers.renderCustomers(...args),
  addCustomerOrder:(...args)=>domainsCustomers.addCustomerOrder(...args),
  saveCustomerOrderField:(...args)=>domainsCustomers.saveCustomerOrderField(...args),
  deleteCustomerOrder:(...args)=>domainsCustomers.deleteCustomerOrder(...args),
  setCustomerFlag:(...args)=>domainsCustomers.setCustomerFlag(...args),
  saveDebtField:(...args)=>domainsCustomers.saveDebtField(...args),
  ...
  openMorningInvoicePicker:(...args)=>domainsCustomers.openMorningInvoicePicker(...args),
  ...
  applySelectedCloudBackup:(...args)=>uiBackup.applySelectedCloudBackup(...args),
