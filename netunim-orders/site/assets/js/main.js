...
const {
  selectors:domainsCustomersSelectors,
  view:domainsCustomersView,
  setCustomerTab,
  toggleCustomerBulkMode,
  toggleCustomerBulkRow,
  toggleCustomerBulkVisible,
  deleteSelectedCustomerRows,
  addCustomerOrder,
  saveCustomerOrderField,
  deleteCustomerOrder,
  setCustomerFlag,
  saveDebtNote,
  openDebtModal,
  ...
  deleteDebt,
  openMorningDocument,
  openStandaloneMorningDocument,
  syncMorningDocumentType,
  syncMorningPaymentType,
  previewMorningDocument,
  createMorningDocument,
  openMorningExistingDocument,
  reconcileMorningDocument,
}=createDomainsCustomers({
  model,
  customerUi,
  uiLayout,
  uiModal,
