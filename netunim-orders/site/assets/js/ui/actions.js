...
const actions={
  ...
  const startupDomains={
    ...
    checks:['open-check-modal','open-check-modal-2','mark-check-deposited','mark-check-cleared','save-check','delete-check','save-check-series','delete-checks-bulk-selected'],
