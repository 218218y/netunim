...
const actions={
  ...
  'orders-bank-date-to':(element,event)=>{setOrdersBankDateBoundary('to',element.value)},
  ...
  'orders-cashflow-check-cutoff':(element,event)=>{saveOrdersCashflowCheckCutoff(element.dataset.changeArg0,element.value)},
  'refresh-orders-credit':(element,event)=>{refreshOrdersCredit(false,'full')},
  'refresh-orders-credit-daily':(element,event)=>{refreshOrdersCredit(false,'daily')},
  'refresh-orders-credit-interactive':(element,event)=>{refreshOrdersCredit(true,'daily')},
  ...
  'customer-order-filter':(element,event)=>{customerUi.customerOrderFilter='all';renderCustomers({resetScroll:true})},
  'customer-order-filter-2':(element,event)=>{customerUi.customerOrderFilter='mattress';renderCustomers({resetScroll:true})},
  ...
  'morning-payment-type':(element,event)=>{syncMorningPaymentType()},
  'morning-preview':(element,event)=>{previewMorningDocument(element)},
  'morning-create':(element,event)=>{createMorningDocument(element)},
  'morning-open-document':(element,event)=>{openMorningExistingDocument(element.dataset.clickArg0,element)},
  ...
  const startupDomains={
    orders:['open-selected-supplier-move','save-supplier-order','supplier-order-drag-start','supplier-order-drop','move-supplier-order','move-supplier-order-2','open-supplier-move-confirm','execute-supplier-transaction-move','save-supplier-year-boundary','remove-supplier-year-boundary','open-transaction-modal','open-selected-supplier-year-boundary','delete-selected-transactions','set-inline-tri','set-inline-tri-2','set-inline-bool','set-inline-bool-2','save-inline-text','save-inline-text-2','open-transaction-modal-2','open-transaction-modal-3','save-transaction','delete-transaction','save-supplier','open-debt-modal','add-customer-order','save-customer-order-field','delete-customer-order','set-customer-flag','set-customer-flag-2','save-debt-note','open-debt-modal-2','save-debt','delete-debt','delete-selected-customer-rows','open-morning-document','open-morning-standalone','morning-create','open-service-modal','toggle-service-flag','open-service-modal-2','save-service','delete-service','delete-selected-service-calls','save-inventory-category-order','inventory-category-order-drag-start','inventory-category-order-drop','move-inventory-category-order','move-inventory-category-order-2','open-inventory-event-modal','open-stock-receive','open-inventory-event-modal-2','open-stock-adjustment-modal','open-inventory-item-modal','archive-selected-inventory-items','open-inventory-item-modal-2','open-warehouse-order-modal','receive-incoming','edit-inventory-event','cancel-incoming','pickup-reservation','release-reservation','set-warehouse-order-status','set-warehouse-order-status-2','set-warehouse-order-status-3','set-warehouse-order-status-4','open-warehouse-order-modal-2','save-inventory-item','archive-inventory-item','save-stock-adjustment','save-inventory-event','confirm-receive','save-warehouse-order','delete-warehouse-order','delete-selected-sticky-notes','update-sticky-note','delete-sticky-note','open-sticky-note-reminder','save-sticky-note-reminder','dismiss-note-reminder','add-sticky-note','open-supplier-modal','open-supplier-order-modal','open-selected-supplier-editor','open-inventory-category-order-modal'],
    checks:['open-check-modal','open-check-modal-2','mark-alert-check-deposited','mark-check-deposited','mark-check-cleared','save-check','delete-check','save-check-series','delete-checks-bulk-selected'],
    finance:['save-orders-bank-token','configure-orders-bank','select-orders-bank-account','delete-orders-bank-credentials','refresh-orders-bank','refresh-orders-bank-interactive','set-orders-bank-auto','orders-cashflow-minimum','orders-cashflow-check-cutoff','refresh-orders-credit','refresh-orders-credit-daily','refresh-orders-credit-interactive','set-orders-credit-auto','set-orders-credit-auto-mode','orders-credit-included','orders-credit-hidden','orders-credit-account','orders-credit-name','orders-credit-manual-frame','open-orders-credit-connection','save-orders-credit-connection','delete-orders-credit-connection','reset-orders-credit-sync'],
    all:['apply-json-restore','apply-orders-cloud-backup-restore','begin-json-restore','finish-cloud-login','enable-cloud','open-cloud','logout-cloud']
  };
  for(const [domain,names] of Object.entries(startupDomains))for(const name of names){
    const action=actions[name];
    if(typeof action!=='function')throw new Error('Unknown startup mutation action: '+name);
    Object.defineProperty(action,'startupMutationDomain',{value:domain});
  }
  return actions;
}
