...
const actions={
  ...
  const startupDomains={
    ...
    calendar:['calendar-auth','calendar-new-event','calendar-new-day','calendar-day-create','calendar-open-event','calendar-toggle-all-day','calendar-start-date-change','calendar-end-date-change','calendar-quick-save','calendar-quick-details','calendar-save-event','calendar-delete-event'],
  ...
  const optionalNotesMutations=['add-notes-sheet','delete-notes-sheet','rename-notes-sheet','add-notes-sheet-row','add-notes-sheet-row-after','update-notes-sheet-cell','save-notes-sheet-cell','delete-notes-sheet-row','add-notes-sheet-column','draft-notes-sheet-column-title','rename-notes-sheet-column','set-notes-sheet-column-numeric','delete-notes-sheet-column','spreadsheet-import','spreadsheet-restore','spreadsheet-use-remote'];
  for(const name of optionalNotesMutations)if(typeof actions[name]==='function')Object.defineProperty(actions[name],'startupMutationDomain',{value:'notes'});
  if(actions['credit-card-order-save'])Object.defineProperty(actions['credit-card-order-save'],'startupMutationDomain',{value:'finance'});
  return actions;
}
