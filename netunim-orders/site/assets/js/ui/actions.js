...
return {
  ...
  'calendar-prev-month':(element,event)=>{calendarPrevMonth()},
  'calendar-today':(element,event)=>{calendarToday()},
  'calendar-next-month':(element,event)=>{calendarNextMonth()},
