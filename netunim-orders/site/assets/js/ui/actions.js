...
const actions={
  ...
  'orders-bank-document-choice':(element,event)=>{event?.preventDefault();event?.stopPropagation();openOrdersBankDocumentChoice(Number(element.dataset.clickArg0))},
