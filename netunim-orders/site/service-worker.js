...
const CACHE='orders-app-shell-esm-6c12f04f2719';
const SHELL=[
  './',
  './index.html',
  './assets/app.css',
  ...
  './assets/js/domains/calendar/action-ports.js',
  './assets/js/domains/calendar/controller.js',
  './assets/js/domains/checks/alerts.js',
  ...
  './assets/js/domains/customers/composition.js',
  './assets/js/domains/customers/documents-browser.js',
  './assets/js/domains/customers/documents.js',
