-- Ensure newly inserted bank rows immediately expose their generated archive id to the remainder
-- of merge_bank_transactions. The N pending -> one completed cheque-batch finalizer (and later
