...
export function stringifyStorage(name,value){return measureStorage('checkpoint-stringify',()=>{const text=JSON.stringify(value);storageBytes(name,text);return text})}
