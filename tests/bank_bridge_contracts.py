...
ok('const BRIDGE_VERSION=16' in server and 'version:BRIDGE_VERSION' in server and 'Number(j.version)>=16' in installer and '/health' in installer, 'financial bridge install: installer verifies the credit-frame bridge v16 after hidden startup')
