...
ok('kupaSyncedInstallments' in orders_readout and 'creditSync' in orders_readout and 'checkEffects' not in orders_readout, 'Orders Kupa readout: synchronized credit is included while obsolete check-to-bank effects are excluded')
