...
ok('const BRIDGE_VERSION=12' in server and 'version:BRIDGE_VERSION' in server and 'Number(j.version)>=12' in installer and '/health' in installer, 'financial bridge install: installer verifies multi-profile bank/credit bridge v12 after hidden startup')
