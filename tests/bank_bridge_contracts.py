...
ok('הסנכרון האחרון מהבנק הצליח' in view and 'bankSyncHeadlineMarkup' in view and 'bank-transactions-table' in view and '<th>חובה</th><th>זכות</th>' in view and 'יתרה נוכחית' in view, 'bank UI: last-sync result is the compact disclosure headline and transactions use a bank-like debit/credit table with authoritative current balance')
