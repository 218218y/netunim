...
ok('credit-forecast-month' in credit_view and 'credit-forecast-row' in credit_view and 'credit-forecast-breakdown' in credit_view and credit_view.index('עסקאות ותשלומים פעילים') < credit_view.index('${creditMonthlySummaryDetails(future)}') < credit_view.index("${summary.hasData?renderSyncedAccounts(summary):''}"), 'credit UI hierarchy: compact expandable monthly forecast leads into active transactions, then collapsed monthly summary, with live issuer data last')
