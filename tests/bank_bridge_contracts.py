...
ok('creditDetailPartitionsData' in credit_model and 'CREDIT_DETAIL_HISTORY_DAYS=60' in credit_model and 'היסטוריית עסקאות שהסתיימו' in credit_view and 'עסקאות ותשלומים פעילים' in credit_view, 'credit detail lifecycle: completed zero-remaining series leave ordinary detail and remain in a separate bounded 60-day history')
