...
ok('primaryCardFilterMatch' in credit_view and 'includedCards.filter(card=>primaryCardFilterMatch(ui,card))' in credit_view and "ui.creditProviderFilter==='all'||x.provider===ui.creditProviderFilter" in credit_view, 'credit filter controls: account and owner selections constrain issuer/card chip availability before issuer/card selections are validated')
