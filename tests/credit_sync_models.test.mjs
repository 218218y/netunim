...
assert.deepEqual(creditUpcomingCharge(availabilityAccount,'isracard','2026-09-02'),{amount:300,date:'2026-09-10',source:'transactions',pendingAmount:100,estimated:true},'the upcoming Isracard cycle combines finalized charges with fresh pending ILS authorizations');
