...
return {prefill:true,wholeShekelSpinner:true,noFalseUnsavedAfterIssue:true,standalone:true,verifiedDebtUpdate:true,standaloneDoesNotUpdateDebt:true,verifiedCreate:true,officialPdfAfterCreate:true,timeout:true,operationReconciliation:true,partialReconcileUpdatesDebt:true,reconciliationIdempotent:true,liveSearch:true,pagination:true,cache:true,filters:true,details:true,freshLinks:true,manualInvoicePicker:true};
"""
