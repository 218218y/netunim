...
test('shared cashflow thresholds and alert semantics agree across both apps',()=>{
 ...
 assert.deepEqual(kupaCashflow.normalizeCashflowSettings({businessMinimum:-50,homeMinimum:''}),{version:3,businessMinimum:0,homeMinimum:null,businessCheckCutoffDay:14,homeCheckCutoffDay:9});
 assert.deepEqual(kupaCashflow.normalizeCashflowSettings({businessCheckCutoffDay:31,homeCheckCutoffDay:1}),{version:3,businessMinimum:null,homeMinimum:null,businessCheckCutoffDay:31,homeCheckCutoffDay:1});
