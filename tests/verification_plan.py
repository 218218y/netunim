...
GROUPS = {
    ...
    "browser-sync": ["runtime_storage.py", "spreadsheet_runtime.py", "runtime_workflows.py", "runtime_sync_recovery.py", "runtime_sync_multitab.py", "runtime_sync_two_computers.py", "runtime_financial.py"],
